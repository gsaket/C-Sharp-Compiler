...
string genx86(vector<string> instr){
	...
	else if(op == "read")
	{
		...
		string fmt_string="fmt_str_";
		string typ=instr[3];
		if(typ == "char")fmt_string="fmt_str_chr_";
		x86 += "pushl "+var+"\n";
	...
	else if(op == "print")
	{
		...
		//print statement
		string fmt_string="fmt_str";
		string typ=instr[3];
		if(typ == "char")fmt_string="fmt_str_chr";
...
int main(int argc, char** argv){
	...
	DataSection+="fmt_str_chr:\n.ascii \"%c\\n\\0\"\n";
	DataSection+="fmt_str_chr_:\n.ascii \"%c\"\n";
